...
import { Search, ChevronDown, ChevronUp, MessageCircle, Trash2, CheckSquare, Square, AlertCircle, X } from 'lucide-react';
...
export const FullDataTable = ({ surveys }: FullDataTableProps) => {
  ...
  const filteredSurveys = surveys.filter(s => 
    ...
    (s.overallSentiment || '').toLowerCase().includes(searchTerm.toLowerCase())
  );
        ...
        <div className="flex flex-col md:flex-row items-center gap-3">
          {selectedIds.length > 0 && (
            <button 
              ...
              className="flex items-center gap-2 bg-red-600 text-white px-4 py-2 rounded-xl text-sm font-bold shadow-sm hover:bg-red-700 transition-colors"
            >
          ...
          <div className="relative w-full md:w-64">
            ...
            <input
              type="text"
              placeholder="Buscar por paciente o sentimiento..."
              value={searchTerm}
